...
-- CreateEnum
CREATE TYPE "VisaType" AS ENUM ('F_VISA', 'B_VISA');
...
-- AddForeignKey
ALTER TABLE "Comment" ADD CONSTRAINT "Comment_faqId_fkey" FOREIGN KEY ("faqId") REFERENCES "FAQ"("id") ON DELETE CASCADE ON UPDATE CASCADE;
